#
# Be sure to run `pod lib lint FSRefresh-ObjC.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/Allen/FSRefresh-ObjC.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'FSRefresh-ObjC' => ['FSRefresh-ObjC/Assets/*.png']
  # }
